    ...
    public class UserService : IUserService
    {
        ...
        public async Task<User> RegisterEngineerAsync(UserDTO userDto)
        {
            var user = new User
            {
                ...
                Role = Role.ROLE_ENGINEER.ToString()
            };
        ...
        public async Task<IEnumerable<User>> GetEngineersAsync()
        {
            return await _userRepository.GetUsersByRoleAsync(Role.ROLE_ENGINEER.ToString());
        }
